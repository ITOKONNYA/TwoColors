        ...
        this.execution = () => {
            if (this.phase === 0) {
                ...
                if (this.count < this.countMax) {
                    ...
                    this.codeContainer.style.opacity = (this.count / this.countMax) * 0.5; //0 to 0.5
                } else {
                    this.phase = 3;
                    this.count = 0;
                }
                ...
                if (this.count < this.countMax) {
                    this.count = this.count + this.delta;
                    this.codeContainer.style.opacity = (this.count / this.countMax) * 0.5 + 0.5; //0.5 to 1
                    this.repaintButton.style.opacity = (this.count / this.countMax) * 0.5; //0 to 0.5
                } else {
                    this.phase = 4;
                    this.count = 0;
                }
                ...
                if (this.count < this.countMax) {
                    this.count = this.count + this.delta;
                    this.repaintButton.style.opacity = (this.count / this.countMax) * 0.5 + 0.5; //0.5 to 1
                    this.header.style.opacity = (this.count / this.countMax) * 0.5; //0 to 0.5
                } else {
                    this.phase = 5;
                    this.count = 0;
                }
                ...
                if (this.count < this.countMax) {
                    this.count = this.count + this.delta;
                    this.header.style.opacity = (this.count / this.countMax) * 0.5 + 0.5; //0.5 to 1
                } else {
                    this.phase = null;
                }
                window.requestAnimationFrame(this.execution);
